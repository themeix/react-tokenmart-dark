...
//     + '<p class="text-blueGray-900 leading-4 font-opens font-medium"><span>%d</span><br><span class="text-sm">Days</span></p>'
//     + '<p class="text-blueGray-900 leading-4 font-opens font-medium"><span>%H</span><br><span class="text-sm">Hrs</span></p> '
//     + '<p class="text-blueGray-900 leading-4 font-opens font-medium"><span>%M</span><br><span class="text-sm">Min</span></p> '
//     + '<p class="text-blueGray-900 leading-4 font-opens font-medium"><span>%S</span><br><span class="text-sm">Sec</span></p>'));
// }); 
